...
//266164/1036079/2.50/54/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "IS42S16800F-6BL" (originalName "IS42S16800F-6BL")
	...
	(compDef "IS42S16800F-6BL" (originalName "IS42S16800F-6BL") (compHeader (numPins 54) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IS42S16800F-6BL"))
		...
		(attr "Mouser Part Number" "870-IS42S16800F-6BL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/ISSI/IS42S16800F-6BL?qs=DfG0HhEx1UUGNCHPCR0H3Q%3D%3D")
		(attr "Manufacturer_Name" "Integrated Silicon Solution Inc.")
		(attr "Manufacturer_Part_Number" "IS42S16800F-6BL")
		(attr "Description" "DRAM 128M 8Mx16 166Mhz SDR SDRAM, 3.3V")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "IS42S16800F-6BL.stp")
