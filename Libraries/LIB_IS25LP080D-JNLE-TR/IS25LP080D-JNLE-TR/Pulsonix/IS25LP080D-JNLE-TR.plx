...
(library Library_1
	...
	(symbolDef "IS25LP080D-JNLE-TR" (originalName "IS25LP080D-JNLE-TR")
	...
	(compDef "IS25LP080D-JNLE-TR" (originalName "IS25LP080D-JNLE-TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IS25LP080D-JNLE-TR"))
		...
		(attr "Mouser Part Number" "870-IS25LP080DJNLETR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/ISSI/IS25LP080D-JNLE-TR?qs=pif5%252B9MYt0VkH9msMJ5aTQ%3D%3D")
		(attr "Manufacturer_Name" "Integrated Silicon Solution Inc.")
		(attr "Manufacturer_Part_Number" "IS25LP080D-JNLE-TR")
		(attr "Description" "8MB QSPI, 8-PIN SOP 150MIL, RO")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "IS25LP080D-JNLE-TR.stp")
